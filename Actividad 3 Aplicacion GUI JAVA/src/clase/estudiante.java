...
public class estudiante {
    ...
    public estudiante (){
        est.put("cedula", "1043965592");
        est.put("nombre", "jeick ");
        est.put("apellido", "mogollon");
        est.put("direccion", "villa grande 1 ");
        est.put("telefono", "3052336659");
        est.put("clave", "12345678");
